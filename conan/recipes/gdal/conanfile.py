...
class GdalConan(ConanFile):
    ...
    def generate(self):
        ...
        tc.cache_variables["GDAL_USE_MUPARSER"] = self.options.with_muparser
    ...
    def package_info(self):
        ...
        if self.options.with_muparser:
            self.cpp_info.requires.extend(["muparser::muparser"])
        if self.options.with_mysql == "libmysqlclient":

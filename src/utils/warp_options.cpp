...
int WarpOptions::parse(Napi::Value value) {
  ...
  if (
    obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "options")).FromMaybe(false) &&
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "memoryLimit")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "resampling")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "dst")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "srcBands")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "dstBands")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "srcNodata")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "dstNodata")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "srcAlphaBand")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "dstAlphaBand")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "blend")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "cutline")).FromMaybe(false)) {
  ...
  if (obj.As<Napi::Object>().HasOwnProperty(Napi::String::New(node_gdal::napi_env, "multi")).FromMaybe(false)) {
